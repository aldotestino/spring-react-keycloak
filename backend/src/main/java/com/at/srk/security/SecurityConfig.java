...
//            return roles.map(List::stream).orElse(Stream.empty()).map(SimpleGrantedAuthority::new).map(GrantedAuthority.class::cast).toList();
//        };
//    }
//
//    @Bean
...
//    }
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        OpaqueTokenIntrospector introspector = new KeyCloakOpaqueTokenIntrospector(introspectionUri, clientId, clientSecret);
